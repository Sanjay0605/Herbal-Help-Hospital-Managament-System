...
// add a function for submitting medical records
...
if(isset($_POST['herb-submit']))
{
  $hid = $_SESSION['hid'];
  $ingredient = $_SESSION['ingredient'];
  $localname = $_SESSION['localname'];
  $sciname = $_SESSION['sciname'];
}
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Herbal Help</h2></br>
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'Georgia', serif;"> Welcome &nbsp<?php echo $username ?> 
   </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-med-list" data-toggle="list" href="#list-med" role="tab" aria-controls="home">Add Medical Record</a>
      <a class="list-group-item list-group-item-action" href="#lisp-pres" id="lisp-pres-list" role="tab" data-toggle="list" aria-controls="home">View Remedy Recipes</a>
      <a class="list-group-item list-group-item-action" href="#lisk-pres" id="lisk-pres-list" role="tab" data-toggle="list" aria-controls="home">View Herb Details</a>
        ...
        <div class="container-fluid container-fullw bg-white" >
              <div class="row">
               <div class="col-sm-4" style="left: 5%">
                ...
                <div class="col-sm-4" style="left: 4%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                ...
                <div class="col-sm-4" style="left: 20%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Medical Record</h2>
                ...
                <div class="col-sm-4" style="left: 4%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Home Remedy</h2>
                ...
                <div class="col-sm-4" style="left: 4%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Herb</h2>
                    
                      <p class="cl-effect-1">
                        <a href="#lisk-pres" onclick="clickDiv('#lisk-pres-list')">
                          View Herb Details
                        </a>
                      </p>
                    </div>
...
<!-- FOR MEDICAL RECORDS -->
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center><h4>Add Medical Record</h4></center><br>
              <form class="form-group" method="post" action="admin-panel.php">
                <div class="row">
                  ...
                  ?> -->
                    <!-- Add a field for medication which is a text field -->
                    <div class="col-md-4">
                          <label for="medication">Medication:</label>
                        </div>
                        <div class="col-md-8">
                          <input type="text" class="form-control" name="medication" id="medication" required="required">
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                         <input type="text" class="form-control" name="condition" id="condition" required="required">
                        </div>

                        <br><br>
                    <div class="col-md-4">
                          <label for="medication">Allergy:</label>
                        </div>
                        <div class="col-md-8">
                         <input type="text" class="form-control" name="allergy" id="allergy" required="required">
                        </div>
...
<!-- 
              ...
              document.getElementById('doctor').onchange = function updateFees(e) {
                ...
                document.getElementById('docFees').value = selection;
                  ...
                  <div class="col-md-4"><label>Surgery Required</label></div>
                  <div class="col-md-8">
                    <!-- <input type="time" class="form-control" name="apptime"> -->
                    <select name="surgreq" class="form-control" id="surgreq" required="required">
                  ...
                  <div class="col-md-4">
                    <input type="submit" name="med-submit" value="Submit" class="btn btn-primary" id="inputbtn">
                  </div>
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
      ...
      <div class="tab-pane fade" id="lisk-pres" role="tabpanel" aria-labelledby="lisk-pres-list">
        ...
        <div class="col-md-2"><input type="submit" name="herb_search_submit" class="btn btn-primary" value="Search"></div></div>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  ?>
                   <div class="col-md-2 btnc">
    <a href="herbimage.php" class="btn btn-primary">Search Herb images</a>
</div>
                </tbody>
              </table>
        <br>
      ...
      <div class="tab-pane fade" id="lisp-pres" role="tabpanel" aria-labelledby="lisp-pres-list">
              

      <div class="col-md-8">
      <form class="form-group" action="recipesearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="recipe_name" placeholder="Enter Recipe Name" class = "form-control"></div>
        <div class="col-md-2"><input type="submit" name="recipe_search_submit" class="btn btn-primary" value="Search"></div></div>
      </form>
    </div>
              <table class="table table-hover">
                <thead>
    ...
    <a href="herbimage.php" class="btn btn-primary">Search Herb images</a>
                ...
                <!-- <a href="herbimage.php">Click here to search herb images</a> -->
      ...
      <div class="tab-pane fade" id="lisp-pres" role="tabpanel" aria-labelledby="lisp-pres-list">
        ...
        <table class="table table-hover">
          ...
          <?php 
            ...
            $query = "select rid, rname, ingredient, proced, videolink from recipe;";
        ...
        <table class="table table-hover">
          ...
          <tbody>
            <?php 
              ...
              $query = "select hid, ingredient, localname, sciname from herb;";
